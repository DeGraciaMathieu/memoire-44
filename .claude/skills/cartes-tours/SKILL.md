...
| Assaut blindé (`armor-assault`)          | 4 blindés, +1 dé au contact                                                                                                              | `n: 4, types: ['arm'], fallback, bonus: 'close'`                                    |
...
| Assaut rapproché (`close-assault`)       | toutes les inf/blindés au contact d'un ennemi, +1 dé, sans bouger (prise de terrain et percée conservées)                                | `n: 'all', types: ['inf','arm'], adjacent: true, noMove, bonus: 'all'`              |
