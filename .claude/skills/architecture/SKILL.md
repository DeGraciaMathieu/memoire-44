...
| `src/hex.js`            | Géométrie pure odd-r : `key`, `inBounds`, `toCube`, `hexDistance`, `neighbors`                                                                         | `config`                                               |
...
| `src/combat.js`         | `defenseReduction`, `diceFor`, `targetsFor`, `rollDice`, `resolveCombat`                                                                               | `config`, `hex`, `movement`                            |
