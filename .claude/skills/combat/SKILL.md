...
| Réduction de terrain | `defenseReduction(state, attackerType, target)` (`src/combat.js`) : `dice.defArmor` si l'attaquant est un blindé, `dice.defArt` si c'est l'artillerie (forêt : 0 = sans malus), sinon `dice.def`                                                                                                                                                                                                                                                                                                                                          |
