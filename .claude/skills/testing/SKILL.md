...
| `test/movement.test.js` | `reachable` : plaine, hex occupé/bloquant, terrains qui stoppent                                         |
...
| `test/game.test.js`     | **MACRO** : déterminisme par graine, tour allié complet, `attackUnit`, rebattage de pioche               |
| `test/html.test.js`     | Fragments purs : `cardHTML`, `forcePanelHTML`, `calcHTML`, `tipHTML`                                     |
| `test/gfx.test.js`      | `boardSize`, aller-retour `hexCenter`/`pickHex`, lignes de secteur                                       |
